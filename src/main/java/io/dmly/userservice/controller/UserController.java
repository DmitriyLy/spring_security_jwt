package io.dmly.userservice.controller;
...
import io.dmly.userservice.service.UserService;
import io.dmly.userservice.utils.SecurityUtils;
import lombok.Data;
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            try {
                ...
                String accessToken = JWT.create()
                        .withSubject(appUser.getUsername()).withExpiresAt(new Date(System.currentTimeMillis() + 10 * 60 * 1000))
